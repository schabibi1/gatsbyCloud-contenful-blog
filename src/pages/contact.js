	...
	return (
		<Layout>
			...
			<div>
				...
				<br />フリーランスのエンジニアとしてドイツで仕事をしています。web開発やwebアプリ開発、プログラミング学習の個別サポート、オンラインプログラミングコースのご受講をご希望でしたら、お気軽にTwitter、Github、もしくは以下のフォームからご連絡ください。
				<br />フリーランス、海外エンジニア転職などのご相談は、MENTAにて 1,000円/単発で承っております👉 <a href="https://menta.work/plan/2157" target="_blank" rel="noopener noreferrer">MENTAご相談受付ページ</a>
			</div>
