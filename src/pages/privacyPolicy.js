...
import privacyStyles from './privacyPolicy.module.scss';
...
const PrivacyPolicy = () => {
  return (
    <Layout>
      ...
      <h3 className={privacyStyles.topSubtitle}>Here is</h3>
      <h1 className={privacyStyles.topTitle}>The Privacy Policy</h1>
      <p>
        プライバシーポリシー（個人情報の取扱い方針）
      </p>

      <ol className={privacyStyles.posts}>
        <li className={privacyStyles.post}>
          <article>
            <div className={privacyStyles.category}>
              <h4 className={privacyStyles.tags}>Privacy Policy</h4>
            </div>
            <h2>プライバシーポリシー（個人情報の取扱い方針）</h2>
            <p>
            本プライバシーポリシーは、https://aiki-developer.com（以下，「当サイト」といいます。）上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
            </p>
            ...
            <h3>第2条（個人情報の収集方法）</h3>
            <p>
            当サイトは，ユーザーがプログラミング学習個別サポート利用申込をする際に、氏名，住所，メールアドレス，クレジットカード番号，などの個人情報をお尋ねすることがあります。また，ユーザーと提携先などとの間でなされたユーザーの個人情報を含む取引記録や決済に関する情報を,当サイトの提携先（決済サービス(Stripe)，請求書管理サービス(Invoice Ninja)，問い合わせフォーム(Netlify)、問い合わせ後の一時的連絡手段(Gmail)、受講決定後の連絡手段(Slack)などを含みます。以下，｢提携先｣といいます。）などから収集することがあります。
            </p>
            ...
            <ol>
              <li>当サイト個別プログラミング学習サポートの提供・運営のため</li>
              <li>ユーザーからのお問い合わせに回答するため（本人確認を行うことを含む）</li>
              <li>ユーザーが利用中のサービスの新機能，更新情報，キャンペーン等及び当サイトが提供する他のサービスの案内の連絡を送付するため</li>
              <li>メンテナンス，重要なお知らせ、料金変更など必要に応じたご連絡のため</li>
              <li>利用規約に違反したユーザーや，不正・不当な目的でサービスを利用しようとするユーザーの特定をし，ご利用をお断りするため</li>
              <li>有料サービスにおいて，ユーザーに利用料金を請求し、ドイツ税務署より依頼があれば請求書を提出する義務があるため</li>
            ...
            <ol>
              ...
              <li>
              利用目的の変更を行った場合には，変更後の目的について，当サイト所定の方法(Slack、またはメール)により，ユーザーに通知し，または本ウェブサイト上に公表するものとします。
              </li>
              ...
              <h3>第10条（お問い合わせ窓口）</h3>
              <p>本ポリシーに関するお問い合わせは，上記にあります、コンタクトフォームの窓口までお願いいたします。</p>
            </ol>
          </article>
        </li>
      </ol>
